...
class NeuralNetwork():
    ...
    def compute_y_yhat(self, data, game_penalty_type, reverse, move_penalty_type):
        ...
        return expanded_game_penalties*move_penalties*y, expanded_game_penalties*move_penalties*y_hat
    ...
    def train(self, lr=0.001, duration=1/600, random_games=False, random_frac=None, batch_size=10,
        ...
        while time.time()<end_time: # run loop for a certain duration (in hours)
            ...
            new_weighted_y, new_weighted_yhat = self.compute_y_yhat(data, game_penalty_type, better_direction, 
                                                                    move_penalty_type)
